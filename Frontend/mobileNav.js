(() => {
  ...
  async function ischDetail(){
    ...
    openDetail("ISCH", "ENTRY STRATEGY CHECKS", `<div class="detail-card"><h3>${symbol} · ENTRY STRATEGY CHECKS</h3><p>Loading checks…</p></div>`);
    try{
      ...
      openDetail("ISCH", "ENTRY STRATEGY CHECKS", `<div class="detail-card"><h3>${symbol} · ENTRY STRATEGY CHECKS</h3><p>Strategy checks unavailable.</p></div>`);
    }
  }
  ...
  async function fundamentalDetail(){
    const symbol=selectedSymbol();
    openDetail("Fundamental Insight", "FUNDAMENTAL INSIGHT", `<div class="detail-card"><h3>${symbol}</h3><p>Loading fundamentals…</p></div>`);
    try{
      ...
      openDetail("Fundamental Insight", "FUNDAMENTAL INSIGHT", `<div class="detail-card"><h3>${symbol} · FUNDAMENTAL INSIGHT</h3><p>Fundamental data unavailable.</p></div>`);
    }
  }
  ...
  async function historyDetail(){
    openDetail("Recent Signal History", "HISTORY", `<div class="detail-card"><h3>Recent Signal History</h3><p>Loading history…</p></div>`);
    try{
      const data=await panelData();
      ...
      openDetail("Recent Signal History", "HISTORY", `<div class="detail-card"><h3>Recent Signal History</h3><p>History unavailable.</p></div>`);
    }
  }

  async function autoTradeDetail(){
    openDetail("Auto Trade", "AUTO TRADE", `<div class="detail-card"><h3>Auto Trade</h3><p>Loading execution status…</p></div>`);
    try{
      const data=await panelData();
      ...
      openDetail("Auto Trade", "AUTO TRADE", `<div class="detail-card"><h3>Auto Trade</h3><p>Status unavailable.</p></div>`);
    }
  }
