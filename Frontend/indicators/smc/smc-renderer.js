...
(function(){
  ...
  class SmcRenderer{
    ...
    render(structure){this.lastStructure=structure||null;this.clear();if(!this.enabled||!this.chart||!this.candleSeries||!structure)return;const settings=this.cfg();(Array.isArray(structure.events)?structure.events:[]).slice(-10).forEach(e=>this.addBreak(e,settings));this.addCurrentStructure(structure,settings);this.addFibs(structure,settings);}
  }
