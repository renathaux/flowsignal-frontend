...
assert.match(loader, /binary\/binary-app\.js\?v=24/);
assert.match(mobile, /binary\/binary\.css\?v=13/);
assert.match(mobile, /binary\/binary-app\.js\?v=24/);
...
assert.match(css, /#flowsignalTradingModeSelector\{position:fixed!important;top:9px!important;z-index:2000100!important\}/, 'desktop mode selector stays above the Owner header while scrolling');
