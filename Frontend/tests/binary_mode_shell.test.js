...
assert.match(loader, /binary\/binary-app\.js\?v=4/);
assert.match(mobile, /binary\/binary\.css\?v=4/);
assert.match(mobile, /binary\/binary-app\.js\?v=4/);
...
assert.match(css, /\.flowsignal-mode-selector\{position:fixed[^}]*left:294px/);
