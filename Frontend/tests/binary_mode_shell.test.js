...
assert.match(script, /AUTHORITATIVE V5 SIGNAL/);
...
assert.match(loader, /binary\/binary-app\.js\?v=3/);
assert.match(mobile, /binary\/binary\.css\?v=3/);
assert.match(mobile, /binary\/binary-app\.js\?v=3/);
