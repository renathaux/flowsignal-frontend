...
assert.match(app, /id="binaryDurationIncrease"/, 'mobile duration can be increased');
assert.match(app, /id="binaryDurationDecrease"/, 'mobile duration can be decreased');
assert.match(app, /binary_duration_minutes/, 'backend duration is authoritative');
